...
const MyBookingsPage: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Мои бронирования</h2>
                  ...
                  {bookings.map((booking) => (
                    <div key={booking.id} className="p-4 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium rounded ${getStatusClass(booking.status)}`}>
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600 dark:text-gray-400">Билеты:</span>
                      ...
                      {booking.status !== 'cancelled' && (
                        <div className="mt-4 flex space-x-2">
                          <button
                            className="px-3 py-1 text-xs font-medium rounded border border-blue-500 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900"
                            onClick={() => {}}
                          >
                            Детали
                          </button>
                          <button
                            className="px-3 py-1 text-xs font-medium rounded border border-red-500 text-red-500 hover:bg-red-50 dark:hover:bg-red-900"
